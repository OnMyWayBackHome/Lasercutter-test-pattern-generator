...
materials = [
    ...
    "header" : ['Foam Core', "Amazon", "thickness 0.25 2 passes"], 
    "powers" : [20, 30, 40], 
    "speeds" : [350, 400, 450, 500],}, 
    {"filename" : "test_cut_cardboard",
    "header" : ['Cardboard', "--", "thickness 0.125"], 
    "powers" : [80, 85, 90], 
    "speeds" : [280, 300, 320],}, 
    {"filename" : "test_cut_foam_1mm",
    "header" : ['Craft Foam 1mm', "Crafters", "thickness 0.04"], 
    "powers" : [15, 20, 25], 
    "speeds" : [200, 210, 220],}, 
    {"filename" : "test_cut_acrylic_solid",
    "header" : ['Acrylic - solid', "estreet", "thickness 0.125"], 
    "powers" : [-1], 
    "speeds" : [190, 210, 230, 250],}, 
    {"filename" : "test_cut_foam_0.1in",
    "header" : ['Craft Foam 1mm', "Creatology", "passes: 2 thick: 0.1"], 
    "powers" : [10, 20, 30], 
    "speeds" : [200, 300, 400],}, 
]
